Voici ta version **nettoyée des doublons**, en gardant toutes les explications détaillées, et avec les emplacements d’images au bon endroit.  
J’ai aussi remplacé les liens GitHub bruts par de la syntaxe Markdown propre, avec les chemins relatifs adaptés à ton arborescence.  
...
Si tu veux, je peux maintenant te faire une **version encore plus propre typographiquement**, en harmonisant aussi les majuscules, les formulations et les légendes d’images.
